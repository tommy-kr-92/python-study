...
class WeeklyWorkPlan:
    ...
    def set_style(self):
        ...
        for i in range(2, 7):
            ...
            # 색상 채우기
            ws[f'{get_column_letter(i)}8'].fill = PatternFill(fgColor='E2EFDA', fill_type='solid')  # fill_type 을 꼭 넣어주어야 한다
        ...
        # 날짜 요일 가운데 정렬
        for i in range(9, 40, 5):   # 9부터 40까지 5씩 증가
        ...
        for col in ws.iter_cols(min_row=8, min_col=2, max_row=len(self.date_list) * 5 + 8, max_col=6):   # iter_cols() 컬럼을 반복하는 함수
            for cell in col:
                cell.border = border_style


if __name__ == '__main__':
    wwp = WeeklyWorkPlan('2024-09-16','허재영', days=5)
